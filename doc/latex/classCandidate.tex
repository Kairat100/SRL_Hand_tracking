...
\hypertarget{classCandidate_a644aceddca7fec98820a1f06e2164ba7}{}\index{Candidate@{Candidate}!````~Candidate@{$\sim$\+Candidate}}
...
Given a vector of candidates, keep only the maximal candidates which overlap less than a defined fractional area. If overlap is 0.\+0 (the default value) no overlap is allowed. If, for example, the overlap is 0.\+2, then two candidates\textquotesingle{} bounding boxes can intersect by 20\%

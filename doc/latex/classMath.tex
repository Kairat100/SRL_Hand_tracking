...
\hypertarget{classMath_a28ea971a536094b9083ec8f36ff357e5}{}\index{Math@{Math}!````~Math@{$\sim$\+Math}}
\index{````~Math@{$\sim$\+Math}!Math@{Math}}
...
Reduce a 3\+D matrix (represented as a vector of matrices using cv\+::split() ) to a 2\+D matrix by choosing a single element from each ray cast through the third dimension. This loosely emulates Matlab\textquotesingle{}s matrix indexing functionality
...
\item 
/home/kairat/\+Dropbox/\+Computer\+Vision/\+Codes/\+Parts\+Based\+Detector/include/\hyperlink{Math_8hpp}{Math.\+hpp}\end{DoxyCompactItemize}

...
The Dynamic Program calculates the best holistic detection given a set of part detections and a model of the parts\textquotesingle{} likely relationships with their parents. The class has two primary methods\+: \hyperlink{classDynamicProgram_ad4f899b21d3423b4fc52ef4fb77cdd86}{min()} and \hyperlink{classDynamicProgram_a7f3276a0014489972129ad7c4a8d4a69}{argmin()}.
...
\index{Dynamic\+Program@{Dynamic\+Program}!Dynamic\+Program@{Dynamic\+Program}}
...
\hypertarget{classDynamicProgram_a68458d8f58efec81d37712bd5ec99b51}{}\index{Dynamic\+Program@{Dynamic\+Program}!````~Dynamic\+Program@{$\sim$\+Dynamic\+Program}}
\index{````~Dynamic\+Program@{$\sim$\+Dynamic\+Program}!Dynamic\+Program@{Dynamic\+Program}}
...
\index{argmin@{argmin}!Dynamic\+Program@{Dynamic\+Program}}
...
\index{distance\+Transform@{distance\+Transform}!Dynamic\+Program@{Dynamic\+Program}}
...
\index{distance\+Transform1\+D@{distance\+Transform1\+D}!Dynamic\+Program@{Dynamic\+Program}}
...
\index{distance\+Transform1\+D\+Mat@{distance\+Transform1\+D\+Mat}!Dynamic\+Program@{Dynamic\+Program}}
...
\index{min@{min}!Dynamic\+Program@{Dynamic\+Program}}
...
\index{dt\+\_\+@{dt\+\_\+}!Dynamic\+Program@{Dynamic\+Program}}
...
\index{thresh\+\_\+@{thresh\+\_\+}!Dynamic\+Program@{Dynamic\+Program}}
